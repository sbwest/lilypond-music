...
\header {
  title = \markup { \abs-fontsize #20 "Suite II" } 
  subtitle = \markup {\abs-fontsize #12 "BWV 1008" }
  % opus = "BWV 1027"
  composer = \markup { \abs-fontsize #12 "J.S. Bach" }
  source = "Neue Bach-Ausgabe BA 5068"
  style = "Baroque"
  mutopiatitle = "Suite II for Solo Cello"
  mutopiacomposer = "BachJS"
  mutopiaopus = "BWV 1008"
...
%%%%%
%% Filename
fileName = "bwv1008-suite-2-d-minor"
%% Movement Titles
% header[N] variables for each movement title or number of work. To be placed in the 'piece' element of a \header block
% Example:
headerI = "1. Prélude"
headerII = "2. Allemande"
headerIII = "3. Courante"
headerIV = "4. Sarabande"
headerV = "5. Menuet I"
headerVI = "6. Menuet II"
headerVII = "7. Gigue"
