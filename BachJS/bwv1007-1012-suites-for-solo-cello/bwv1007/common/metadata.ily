...
\header {
  title = \markup { \abs-fontsize #20 "Suite I" } 
  subtitle = \markup {\abs-fontsize #12 "BWV 1007" }
  % opus = "BWV 1027"
  composer = \markup { \abs-fontsize #12 "J.S. Bach" }
  source = "Neue Bach-Ausgabe BA 5068"
  style = "Baroque"
  mutopiatitle = "Suite I for Solo Cello"
  mutopiacomposer = "BachJS"
  mutopiaopus = "BWV 1007"
...
%%%%%
%% Filename
fileName = "bwv1007-suite-1-g-major"
%% Movement Titles
