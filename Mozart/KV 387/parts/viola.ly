...
\bookpart {
  ...
  \bookOutputName "Mozart - String Quartet in G Major, KV 387 - Viola Part"
  \header {
    pdftitle = "Mozart - String Quartet in G Major, KV 387 - Viola Part"
  ...
  %     \violaThirdMov % From "./iii-viola.ily"
  %     % \new Voice = "breaks" { \violaBreakIII } % From "./viola_defs.ily"
  %     % \new Voice = "overrides" { \violaOverridesIII } % From "./viola_defs.ily"
  %   >>
  %   \layout { }
  % }
  ...
  \score {
    ...
    \new Staff \with { \consists Page_turn_engraver } <<
      ...
      \violaFourthMov % From "./iv-viola.ily"
      % \new Voice = "breaks" { \violaBreakIV } % From "./viola_defs.ily"
      % \new Voice = "overrides" { \violaOverridesIV } % From "./viola_defs.ily"
    >>
    \layout { }
  }
}