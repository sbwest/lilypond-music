...
\bookpart {
  ...
  \bookOutputName "Mozart - String Quartet in G Major, KV 387 - Violin 2 Part"
  \header {
    pdftitle = "Mozart - String Quartet in G Major, KV 387 - Violin 2 Part"
  ...
  %     \violinIIThirdMov % From "./iii-violin2.ily"
  %     % \new Voice = "breaks" { \violinIIBreakIII } % From "./violin2_defs.ily"
  %     % \new Voice = "overrides" { \violinIIOverridesIII } % From "./violin2_defs.ily"
  %   >>
  %   \header {
  %     piece = \headerIII
  %   }
  ...
  \score {
    \new Staff \with { \consists Page_turn_engraver } <<
      ...
      \violinIIFourthMov % From "./iv-violin2.ily"
      % \new Voice = "breaks" { \violinIIBreakIV } % From "./violin2_defs.ily"
      % \new Voice = "overrides" { \violinIIOverridesIV } % From "./violin2_defs.ily"
    >>
    \header {
      piece = \headerIV
    }
